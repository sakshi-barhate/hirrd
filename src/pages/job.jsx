...
const JobPage = () => {
  ...
  return (
    <div className="flex flex-col gap-8 mt-5 px-4 sm:px-6 lg:px-8">
      {/* Logo and Title */}
      ...
      <div className="flex flex-col gap-3">
        <div className="flex justify-between items-center flex-wrap gap-2">
          <div className="flex gap-2 items-center">
            ...
            <span className="text-sm sm:text-base md:text-lg">{job?.location}</span>
          </div>
          <div className="flex gap-2 items-center">
            {job?.isOpen ? (
              <>
      ...
      {/* About the Job */}
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold">About the job</h2>
      <p className="text-base sm:text-lg md:text-xl">{job?.description}</p>

      {/* Requirements */}
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold">
        What we are looking for
      </h2>
      <div className="bg-transparent text-base sm:text-lg md:text-xl">
      ...
      {job?.applications?.length > 0 && job?.recruiter_id === user?.id && (
        <div className="flex flex-col gap-2">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold">Applications</h2>
